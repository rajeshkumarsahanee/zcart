...
$sys['lang'] = array(
    ...
    'search_header_label' => 'Search for people, #hashtags and things',
    ...
    'wondered_comment' => 'scrabed your comment "{comment}" ',
    'liked_post' => 'liked your {postType} {post} ',
    'wondered_post' => 'scrabed your {postType} {post}',
    ...
    'activity_wondered_post' => 'scrabed {user} <a class="main-color" href="{post}">post</a>.',
    ...
    'free_to_login' => 'You\'r free to <a href="' . seoLink('index.php?tab1=welcome') . '">{login}</a> !',
    // admin area 
    ...
    'smooth_links_info' => 'Enable smooth links, e.g.' . $sys['site_url'] . '/home.',
    'seo_frindly_info' => 'Enable SEO friendly url, e.g.' . $sys['site_url'] . '//1_hello-how-are-you-doing.html',
    ...
    'post_login_requriement' => 'Please log in to like,scrab,share and comment !',
    'likes' => 'Likes',
    'like' => 'Like',
    'wonder' => 'Scrab',
    'wonders' => 'Scrabs',
    ...
    'language' => 'Language',
    'copyrights' => 'Copyright © ' . date('Y') . ' ' . $sys['site_name'] . '. All rights reserved.',
    // time + dates 
    'year' => 'year',
    'month' => 'month',
    'day' => 'day',
    ...
    'welcome_wonder_text' => 'Scrab (NEW), ability to scrab a post if you found SUPER DUPER AWESOME.',
    ...
    'welcome_find_more_text' => 'Find more of what you\'re looking for with WoScrab Search. ',
    ...
    'my_groups' => 'My Groups',
    'school' => 'School',
    'site_keywords_help' => 'Example: social, scrab, social site',
    ...
    'e_wondered_my_posts' => 'Someone scrabed my posts',
    ...
    'wondered_reply_comment' => 'scrabed your reply "{comment}"',
