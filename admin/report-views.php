...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Views Report - Admin</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Views Report</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Views Report</h3>
                                                ...
                                                <table class="table">
                                                    ...
                                                    foreach ($productviews as $productview) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $productview['v_date'] ?></td>
                                                            <td><?php echo $productview['views'] ?></td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                </table>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block border-right">
                                              <!--<span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 17%</span>-->
                                                <h5 class="description-header"><?php echo $totalviews; ?></h5>
                                        ...
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block border-right">
                                                ...
                                                <h5 class="description-header">NA</h5>
        ...
        <script>
            $(function () {
                ...
                $('#reportdaterange').on("change", function () {
                    window.location.href = "<?php echo $sys['config']['site_url'].'/admin/report-views'; ?>?daterange=" + encodeURI($(this).val());
                });
            });
        </script>
    </body>
