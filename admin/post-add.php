...
if (isset($_POST['post_title']) && isset($_POST['post_name'])) {
    ...
    $post['post_excerpt'] = filter_var(trim($_POST['post_excerpt']), FILTER_SANITIZE_STRING);
    $post['post_author'] = getUserLoggedId();
    $post['post_password'] = isset($_POST['post_password']) ? filter_var(trim($_POST['post_excerpt']), FILTER_SANITIZE_STRING) : "";
    $post['post_name'] = filter_var(trim($_POST['post_name']), FILTER_SANITIZE_STRING);
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Add <?= $sys['post_types'][$post_type]['name'] ?> - Admin</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <?php include 'css.php'; ?>
        <link rel="stylesheet" href="<?= $sys['config']['site_url'] ?>/admin/plugins/select2/select2.min.css">
        <style>
            #permalink {
                padding: 3px 0px;
            }
                        ...
                        <div class="row">                        
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="post_title" id="post_title" placeholder="Title" required="">
                                    <div id="permalink" style="display:none;"><b>Permalink:</b> 
                                        <span id="sample-permalink"><a href="" target="_blank"><?= $sys['site_url'] ?>/<span class="editable-part"></span>/</a></span>
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <textarea name="meta_others" class="form-control" placeholder="Meta Others"></textarea>
                                        </div>
                                    </div><!-- /.box-body -->
                                </div>
                                <?php if (in_array($post_type, array("post"))) { ?>
                                    ...
                                    <div class="box box-default">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                <textarea name="post_excerpt" class="form-control" placeholder="Excerpt"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="checkbox" name="comment_status" value="open"/> Allow Comments<br/>
                                            <input type="checkbox" name="ping_status" value="open"/> Allow Pingbacks
                                        </div>
                                    </div>
                                </div>
                                <div class="box box-default">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="post_author">
                                                <?php foreach ($authors as $a) { ?>
                                                    <option value="<?= $a['id'] ?>" <?= $a['id'] == getUserLoggedId() ? "selected" : "" ?>><?= $a['display_name'] . " (" . $a['username'] . ")" ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="publishing-actions">
                                                    <input type="submit" name="save" id="save-post" value="Save Draft" class="btn btn-default btn-sm pull-left">
                                                ...
                                                <div class="publishing-actions" style="margin-top: 5px;line-height: 1.7;">
                                                    <div class="post-status">
                                                        Status: <strong id="post-status-display">Draft</strong>
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                <?php foreach ($sys['post_formats'] as $key => $value) { ?>
                                                    <input type="radio" name="post_format" value="<?= $key ?>" <?= $key == "standard" ? "checked" : "" ?>/> <?= $value['name'] ?><br/>
                                                <?php } ?>
                                            </div>
                                        </div><!-- /.box-body -->
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <ul class="nav categories">
                                                    ...
                                                    foreach ($categories as $category) {
                                                        ?>     
                                                    <li><label><input type="checkbox" name="terms[]" value="<?= $category['id'] ?>"> <?= $category['name'] ?></label><li>
                                                    <?php } ?>                    
                                                </ul>
                                            </div>
                                        ...
                                        <div class="box-body">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="submit" class="btn btn-default btn-flat">Add</button>
                                                </span>
                                            </div>
                ...
                CKEDITOR.instances.content.on("change", function () {
                    ...
                    $.ajax({
                        ...
                        if (data.code === '<?= SUCCESS_RESPOSE_CODE ?>') {
                            ...
                            $("#post-add-form").attr("action", "post-edit.php?id=" + data.post_id);
                        }
                    }).fail(function (data) {
                        //any message
                    });
