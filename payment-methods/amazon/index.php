...
if (isset($_POST['code']) && isUserHavePermission(PAYMENT_METHODS_SECTION, getUserLoggedId())) {
    ...
    $fields['accesskey'] = filter_var(trim($_POST['accesskey']), FILTER_SANITIZE_STRING);
    $fields['secretkey'] = filter_var(trim($_POST['secretkey']), FILTER_SANITIZE_STRING);
    $fields['clientid'] = filter_var(trim($_POST['clientid']), FILTER_SANITIZE_STRING);
    $fields['mode'] = filter_var(trim($_POST['mode']), FILTER_SANITIZE_STRING);
    $pmethod['fields'] = json_encode($fields);
    
    if ($fields['merchantid'] == '' || $fields['accesskey'] == '' || $fields['secretkey'] == '' || $fields['clientid'] == '' || $fields['mode'] == '') {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="accesskey" value="<?= isset($fields['accesskey']) ? $fields['accesskey'] : '' ?>" id="accesskey" placeholder="Access Key" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="secretkey" value="<?= isset($fields['secretkey']) ? $fields['secretkey'] : '' ?>" id="secretkey" placeholder="Secret Key" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="clientid" value="<?= isset($fields['clientid']) ? $fields['clientid'] : '' ?>" id="clientid" placeholder="Client Id" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
