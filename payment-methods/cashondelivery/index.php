...
if (isset($_POST['code']) && isUserHavePermission(PAYMENT_METHODS_SECTION, getUserLoggedId())) {
    ...
    $fields['notes'] = filter_var(trim($_POST['notes']), FILTER_SANITIZE_STRING);
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>COD (Cash on Delivery) Note*</label>
                                                    <textarea class="form-control" name="notes" id="notes" placeholder="Notes" required><?= isset($fields['notes']) ? $fields['notes'] : '' ?></textarea>
