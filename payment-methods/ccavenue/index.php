...
if (isset($_POST['code']) && isUserHavePermission(PAYMENT_METHODS_SECTION, getUserLoggedId())) {
    ...
    $fields['accesscode'] = filter_var(trim($_POST['accesscode']), FILTER_SANITIZE_STRING);
    $fields['workingkey'] = filter_var(trim($_POST['workingkey']), FILTER_SANITIZE_STRING);
    $fields['mode'] = filter_var(trim($_POST['mode']), FILTER_SANITIZE_STRING);
    $pmethod['fields'] = json_encode($fields);
    
    if ($fields['merchantid'] == '' || $fields['accesscode'] == '' || $fields['workingkey'] == '' || $fields['mode'] == '') {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="accesscode" value="<?= isset($fields['accesscode']) ? $fields['accesscode'] : '' ?>" id="accesscode" placeholder="Access Code" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="workingkey" value="<?= isset($fields['workingkey']) ? $fields['workingkey'] : '' ?>" id="workingkey" placeholder="Working Key" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
