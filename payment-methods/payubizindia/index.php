...
if (isset($_POST['code']) && isUserHavePermission(PAYMENT_METHODS_SECTION, getUserLoggedId())) {
    ...
    $fields['salt'] = filter_var(trim($_POST['salt']), FILTER_SANITIZE_STRING);
    $fields['mode'] = filter_var(trim($_POST['mode']), FILTER_SANITIZE_STRING);
    $pmethod['fields'] = json_encode($fields);
    
    if ($fields['merchantkey'] == '' || $fields['salt'] == '' || $fields['mode'] == '') {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="merchantkey" value="<?= isset($fields['merchantkey']) ? $fields['merchantkey'] : '' ?>" id="merchantid" placeholder="Merchant Key" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Salt*</label>
                                                    <input type="text" class="form-control" name="salt" value="<?= isset($fields['salt']) ? $fields['salt'] : '' ?>" id="salt" placeholder="Salt" required/>
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="row">
